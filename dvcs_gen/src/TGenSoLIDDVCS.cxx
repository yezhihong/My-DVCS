//
// TGenSoLIDDVCS.cxx, v1.0, Tue Aug 4 11:13:57
  ...
  TGenSoLIDDVCS::TGenSoLIDDVCS(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,TargType, seed1,seed2)
{
  ...
  cout<<"TGenSoLIDDVCS constructor"<<endl;
...
//_____________________________________________________________________________
Double_t TGenSoLIDDVCS::KellyE(Double_t q2)
{
  Int_t ia=1, ib=3;
  Double_t a[1]={-0.24};
...
//_____________________________________________________________________________
Double_t TGenSoLIDDVCS::KellyM(Double_t q2)
{
  Int_t ia=1, ib=3;
  Double_t a[1]={0.12};
...
//_____________________________________________________________________________
Double_t* TGenSoLIDDVCS::Interpol_CFF(Double_t Q2, Double_t xb, Double_t t)
{
...
//_____________________________________________________________________________
Double_t TGenSoLIDDVCS::XSecSum(int opt)
{
...
//_____________________________________________________________________________
Double_t TGenSoLIDDVCS::XSecDif(void)
{
  // returns d4Sigma/dQ2dxdtdphi in nb/GeV4
...
//_____________________________________________________________________________
Double_t TGenSoLIDDVCS::XSecDouble(int opt)
{
...
//_____________________________________________________________________________
TGenSoLIDDVCS::TGenSoLIDDVCS(const TGenSoLIDDVCS& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenSoLIDDVCS&)TCalobase).Copy(*this);
}

//_____________________________________________________________________________
 TGenSoLIDDVCS::~TGenSoLIDDVCS()
{
  // Default destructor
...
//_____________________________________________________________________________
void TGenSoLIDDVCS::IntRCBef(void)
{
...
//_____________________________________________________________________________
void TGenSoLIDDVCS::IntRCAft(void)
{
...
//_____________________________________________________________________________
  void TGenSoLIDDVCS::Settmin(Double_t tmin) { 
    //BEWARE : When generating events in a loop, the TGenSoLIDDVCS::Clear() method,
    //which needs to be used at the end of the loop, sets tmin=-2. and tmax=0.
    //If you don't want these default values, you need to use TGenSoLIDDVCS::Settmin()
    //and TGenSoLIDDVCS::Settmax() at the beginning of the loop to set your values
ftmin=tmin ; 
}
//_____________________________________________________________________________
  void TGenSoLIDDVCS::Settmax(Double_t tmax) {
    //BEWARE : When generating events in a loop, the TGenSoLIDDVCS::Clear() method,
    //which needs to be used at the end of the loop, sets tmin=-2. and tmax=0.
    //If you don't want these default values, you need to use TGenSoLIDDVCS::Settmin()
    //and TGenSoLIDDVCS::Settmax() at the beginning of the loop to set your values
...
//_____________________________________________________________________________
  void TGenSoLIDDVCS::Clear(char* opt) 
    {
      ...
      // TGenSoLIDDVCS::Settmin() and TGenSoLIDDVCS::Settmax() at the beginning of your
      // loop
...
//_____________________________________________________________________________
 void TGenSoLIDDVCS::ComputeDVCS(void) 
{ 
...
//_____________________________________________________________________________
 void TGenSoLIDDVCS::Compute2Body(Double_t m) 
{ 
...
//_____________________________________________________________________________
void TGenSoLIDDVCS::ApplySoLIDAcc(Double_t avv)
{
  ...
  const Double_t fSpecPhiAcc = (fSoLIDAzimAccMax-fSoLIDAzimAccMin)/2.;//rad
  Double_t av= avv;
...
//_____________________________________________________________________________
void TGenSoLIDDVCS::ApplySpecVerAcc(Double_t aav)
{
  // Applies vertical spectrometer acceptance by rotating all 4-vectors
  // around the beam axis. An angle can be specified, otherwise it's generated
  // randomly between spectrometer acceptances
...
//_____________________________________________________________________________
 TLorentzVector* TGenSoLIDDVCS::GetFinalPhoton(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSoLIDDVCS::GetFinalProton(void)
{
  // Returns the final photon 4-vector if it exists
...
//_____________________________________________________________________________
 Double_t TGenSoLIDDVCS::GetFastWeight(void)
{
...
//_____________________________________________________________________________
 void TGenSoLIDDVCS::XSec(void)
{
  // Computes the SoLIDDVCS cross-section for both electron helicities
...
//_____________________________________________________________________________
 void TGenSoLIDDVCS::SetTheoryParam(Int_t phasespace, Int_t prop, Double_t b, Int_t tdep, Double_t tcoef, Int_t DD, Double_t Ju, Double_t Jd, Int_t dterm, Int_t pipole)
{
  //Sets parameters for the library used to compute the SoLIDDVCS cross-section
...
//_____________________________________________________________________________
void TGenSoLIDDVCS::Write2File(void)
{
...
//_____________________________________________________________________________
 void TGenSoLIDDVCS::Print(char* opt)
{
