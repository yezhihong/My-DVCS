void plot_bsa(const TString& TPol,const TString& energy,const int Q2_flag, const int xb_flag, const int t_flag, int *all_bin){
	...
	t1->SetNDC();
        ...
        TH2F *h1 = new TH2F("h1","", 100, 0., 360, 100, -0.1, 0.1);
