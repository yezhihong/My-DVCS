//
// TGenPi0.cxx, v1.0, Tue Aug 4 11:13:57
...
//_____________________________________________________________________________
  TGenPi0::TGenPi0(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,TargType,seed1,seed2)
{
  // Default constructor
...
//_____________________________________________________________________________
TGenPi0::TGenPi0(const TGenPi0& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenPi0&)TCalobase).Copy(*this);
}
...
//_____________________________________________________________________________
 void TGenPi0::ComputeTminTmax(Double_t m3,Double_t m4) 
{ 
...
//_____________________________________________________________________________
 void TGenPi0::Compute2Body(Double_t m) 
{ 
...
//_____________________________________________________________________________
void TGenPi0::TwoBodyDecay(Double_t M, Double_t m1, Double_t m2)
{
...
//_____________________________________________________________________________
void TGenPi0::ApplyAcc(Double_t avv, Double_t AzimAccMin, Double_t AzimAccMax)
{
...
//_____________________________________________________________________________
void TGenPi0::ApplySpecVerAcc(Double_t aav)
{
  // Applies vertical spectrometer acceptance by rotating all 4-vectors
  // around the beam axis. An angle can be specified, otherwise it's generated
  // randomly between spectrometer acceptances
...
//_____________________________________________________________________________
 TLorentzVector* TGenPi0::GetFinalPhoton1(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenPi0::GetFinalPhoton2(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenPi0::GetFinalProton(void)
{
