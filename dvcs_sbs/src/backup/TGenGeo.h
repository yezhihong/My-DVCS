...
class TGenGeo : public TObject
{
  ...
  Double_t    fCaloAngle;          // Calorimeter+PRD angle (rad)
  ...
  Double_t    fPRDPolarAccMax;// PRD maximum polar acceptance (rad)
  Double_t    fPRDPolarAccMin;// PRD minimum polar acceptance (rad)
  Double_t    fPRDAzimAccMax; // PRD maximum azimuth acceptance (rad)
  Double_t    fPRDAzimAccMin; // PRD minimum azimuth acceptance (rad)
  ...
  void SetPRDAcceptance(Double_t PolAccMax, Double_t PolAccMin, Double_t AzimAccMax, Double_t AzimAccMin);
  ...
  Bool_t HitsPRD(TLorentzVector* p);
