//
// TGenSBSDVCS.cxx, v1.0, Tue Aug 4 11:13:57
...
#ifndef __TGenSBSDVCS__
#include "TGenSBSDVCS.h"
#endif

using namespace std;

ClassImp(TGenSBSDVCS)
...
//_____________________________________________________________________________
  TGenSBSDVCS::TGenSBSDVCS(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,TargType, seed1,seed2)
{
  // Default constructor
  ...
  cout<<"TGenSBSDVCS constructor"<<endl;

  fdmom=0;
  frho=0;
  fTargType=TargType;
  if(fTargType!=1 && fTargType!=0 && fTargType!=2 && fTargType!=3){
    cout<<"Unknown target for SBSDVCS Event generator"<<endl;
    exit(1);
  }
...
//_____________________________________________________________________________
Double_t TGenSBSDVCS::KellyE(Double_t q2)
{
  Int_t ia=1, ib=3;
  Double_t a[1]={-0.24};
...
//_____________________________________________________________________________
Double_t TGenSBSDVCS::KellyM(Double_t q2)
{
  Int_t ia=1, ib=3;
  Double_t a[1]={0.12};
...
//_____________________________________________________________________________
Double_t* TGenSBSDVCS::Interpol_CFF(Double_t Q2, Double_t xb, Double_t t)
{
...
//_____________________________________________________________________________
Double_t TGenSBSDVCS::XSecSum(int opt)
{
...
//_____________________________________________________________________________
Double_t TGenSBSDVCS::XSecDif(void)
{
  // returns d4Sigma/dQ2dxdtdphi in nb/GeV4
...
//_____________________________________________________________________________
Double_t TGenSBSDVCS::XSecDouble(int opt)
{
...
//_____________________________________________________________________________
TGenSBSDVCS::TGenSBSDVCS(const TGenSBSDVCS& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenSBSDVCS&)TCalobase).Copy(*this);
}

//_____________________________________________________________________________
 TGenSBSDVCS::~TGenSBSDVCS()
{
  // Default destructor
...
//_____________________________________________________________________________
void TGenSBSDVCS::IntRCBef(void)
{
...
//_____________________________________________________________________________
void TGenSBSDVCS::IntRCAft(void)
{
...
//_____________________________________________________________________________
  void TGenSBSDVCS::Settmin(Double_t tmin) { 
    //BEWARE : When generating events in a loop, the TGenSBSDVCS::Clear() method,
    //which needs to be used at the end of the loop, sets tmin=-2. and tmax=0.
    //If you don't want these default values, you need to use TGenSBSDVCS::Settmin()
    //and TGenSBSDVCS::Settmax() at the beginning of the loop to set your values
ftmin=tmin ; 
}
//_____________________________________________________________________________
  void TGenSBSDVCS::Settmax(Double_t tmax) {
    //BEWARE : When generating events in a loop, the TGenSBSDVCS::Clear() method,
    //which needs to be used at the end of the loop, sets tmin=-2. and tmax=0.
    //If you don't want these default values, you need to use TGenSBSDVCS::Settmin()
    //and TGenSBSDVCS::Settmax() at the beginning of the loop to set your values
...
//_____________________________________________________________________________
  void TGenSBSDVCS::Clear(char* opt) 
    {
      ...
      // TGenSBSDVCS::Settmin() and TGenSBSDVCS::Settmax() at the beginning of your
      // loop
...
//_____________________________________________________________________________
 void TGenSBSDVCS::ComputeDVCS(void) 
{ 
...
//_____________________________________________________________________________
 void TGenSBSDVCS::Compute2Body(Double_t m) 
{ 
...
//_____________________________________________________________________________
void TGenSBSDVCS::ApplySBSAcc(Double_t avv)
{
  ...
  const Double_t fSpecPhiAcc = (fSBSAzimAccMax-fSBSAzimAccMin)/2.;//rad
  Double_t av= avv;
...
//_____________________________________________________________________________
void TGenSBSDVCS::ApplySpecVerAcc(Double_t aav)
{
  // Applies vertical spectrometer acceptance by rotating all 4-vectors
  // around the beam axis. An angle can be specified, otherwise it's generated
  // randomly between spectrometer acceptances
...
//_____________________________________________________________________________
 TLorentzVector* TGenSBSDVCS::GetFinalPhoton(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSBSDVCS::GetFinalProton(void)
{
  // Returns the final photon 4-vector if it exists
...
//_____________________________________________________________________________
 Double_t TGenSBSDVCS::GetFastWeight(void)
{
...
//_____________________________________________________________________________
 void TGenSBSDVCS::XSec(void)
{
  // Computes the SBSDVCS cross-section for both electron helicities
...
//_____________________________________________________________________________
 void TGenSBSDVCS::SetTheoryParam(Int_t phasespace, Int_t prop, Double_t b, Int_t tdep, Double_t tcoef, Int_t DD, Double_t Ju, Double_t Jd, Int_t dterm, Int_t pipole)
{
  //Sets parameters for the library used to compute the SBSDVCS cross-section
...
//_____________________________________________________________________________
void TGenSBSDVCS::Write2File(void)
{
...
//_____________________________________________________________________________
 void TGenSBSDVCS::Print(char* opt)
{
