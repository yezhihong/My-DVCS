//
// TGenSBSDVCS.h, v1.0, Tue Aug 4 11:13:57
// Author: C. Munoz Camacho
//

#ifndef __TGenSBSDVCS__
#define __TGenSBSDVCS__
...
// TGenSBSDVCS.h
//
// SBSDVCS Event generator class
// 
////////////////////////////////////////////////////////////////////////////////

class TGenSBSDVCS : public TGenBase
{
  private :
 ...
 public :
  ...
  TGenSBSDVCS(Double_t Ebeam, Int_t TargType, UInt_t seed1=1, UInt_t seed2=2);
  TGenSBSDVCS(const TGenSBSDVCS&);
  virtual ~TGenSBSDVCS();
  ...
  void ApplySBSAcc(Double_t aav=-1.);
 ...
 Double_t SetT(Double_t t){ft=t;}
  ...
  ClassDef(TGenSBSDVCS,1) // DVCS Event Generator Class

}; // End of TGenSBSDVCS class definition
