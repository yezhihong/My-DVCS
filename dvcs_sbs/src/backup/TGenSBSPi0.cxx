//
// TGenSBSPi0.cxx, v1.0, Tue Aug 4 11:13:57
...
#ifndef __TGenSBSPi0__
#include "TGenSBSPi0.h"
#endif
...
//_____________________________________________________________________________
  TGenSBSPi0::TGenSBSPi0(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,TargType,seed1,seed2)
{
  // Default constructor
  ...
  cout<<"TGenSBSPi0 constructor"<<endl;
...
//_____________________________________________________________________________
TGenSBSPi0::TGenSBSPi0(const TGenSBSPi0& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenSBSPi0&)TCalobase).Copy(*this);
}

//_____________________________________________________________________________
 TGenSBSPi0::~TGenSBSPi0()
{
  // Default destructor
...
//_____________________________________________________________________________
 void TGenSBSPi0::ComputePi0(void) 
{ 
...
//_____________________________________________________________________________
 void TGenSBSPi0::ComputeTminTmax(Double_t m3,Double_t m4) 
{ 
...
//_____________________________________________________________________________
 void TGenSBSPi0::Compute2Body(Double_t m) 
{ 
...
//_____________________________________________________________________________
void TGenSBSPi0::TwoBodyDecay(Double_t M, Double_t m1, Double_t m2)
{
...
//_____________________________________________________________________________
void TGenSBSPi0::ApplySBSAcc(Double_t avv)
{
...
//_____________________________________________________________________________
void TGenSBSPi0::ApplySpecVerAcc(Double_t aav)
{
  // Applies vertical spectrometer acceptance by rotating all 4-vectors
  // around the beam axis. An angle can be specified, otherwise it's generated
  // randomly between spectrometer acceptances
...
//_____________________________________________________________________________
 TLorentzVector* TGenSBSPi0::GetFinalPhoton1(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSBSPi0::GetFinalPhoton2(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSBSPi0::GetFinalProton(void)
{
...
//_____________________________________________________________________________
void TGenSBSPi0::Write2File(void)
{
  ...
  *output<<fQ2<<" "<<fxb<<" "<<ft<<" "<<fphi<<" ";
  *output<<fSigmaP<<" "<<fSigmaM<<" "<<fPSF; 
  *output<<endl;
...
//___________________________________________________________________
 void TGenSBSPi0::Print(char* opt)
{
