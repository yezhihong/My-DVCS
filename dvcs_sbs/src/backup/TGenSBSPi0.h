//
// TGenSBSPi0.h, v1.0, Tue Aug 4 11:13:57
// Author: C. Munoz Camacho
//

#ifndef __TGenSBSPi0__
#define __TGenSBSPi0__
...
class TGenSBSPi0 : public TGenBase
{
  private :
  ...
  TGenSBSPi0(Double_t Ebeam, Int_t TargType, UInt_t seed1=1, UInt_t seed2=2);
  TGenSBSPi0(const TGenSBSPi0&);
  virtual ~TGenSBSPi0();
  ...
  ClassDef(TGenSBSPi0,1) // Pi0 Event Generator Class

}; // End of TGenSBSPi0 class definition
