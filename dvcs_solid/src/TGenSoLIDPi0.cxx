//
// TGenSoLIDPi0.cxx, v1.0, Tue Aug 4 11:13:57
...
#ifndef __TGenSoLIDPi0__
#include "TGenSoLIDPi0.h"
#endif

using namespace std;

ClassImp(TGenSoLIDPi0)
  ...
  TGenSoLIDPi0::TGenSoLIDPi0(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,TargType,seed1,seed2)
{
  ...
  cout<<"TGenSoLIDPi0 constructor"<<endl;
...
//_____________________________________________________________________________
TGenSoLIDPi0::TGenSoLIDPi0(const TGenSoLIDPi0& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenSoLIDPi0&)TCalobase).Copy(*this);
}

//_____________________________________________________________________________
 TGenSoLIDPi0::~TGenSoLIDPi0()
{
  // Default destructor
...
//_____________________________________________________________________________
void TGenSoLIDPi0::IntRCBef(void)
{
...
//_____________________________________________________________________________
void TGenSoLIDPi0::IntRCAft(void)
{
...
//_____________________________________________________________________________
 void TGenSoLIDPi0::ComputePi0(void) 
{ 
...
//_____________________________________________________________________________
 void TGenSoLIDPi0::ComputeTminTmax(Double_t m3,Double_t m4) 
{ 
...
//_____________________________________________________________________________
 void TGenSoLIDPi0::Compute2Body(Double_t m) 
{ 
...
//_____________________________________________________________________________
void TGenSoLIDPi0::TwoBodyDecay(Double_t M, Double_t m1, Double_t m2)
{
...
//_____________________________________________________________________________
void TGenSoLIDPi0::ApplySoLIDAcc(Double_t avv)
{
...
//_____________________________________________________________________________
void TGenSoLIDPi0::ApplySpecVerAcc(Double_t aav)
{
  // Applies vertical spectrometer acceptance by rotating all 4-vectors
  // around the beam axis. An angle can be specified, otherwise it's generated
  // randomly between spectrometer acceptances
...
//_____________________________________________________________________________
 TLorentzVector* TGenSoLIDPi0::GetFinalPhoton1(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSoLIDPi0::GetFinalPhoton2(void)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenSoLIDPi0::GetFinalProton(void)
{
...
//_____________________________________________________________________________
void TGenSoLIDPi0::Write2File(void)
{
...
//___________________________________________________________________
 void TGenSoLIDPi0::Print(char* opt)
{
