//
// TGenPi0Photo.cxx, v1.0, Tue Aug 4 11:13:57
...
#include "TGenPi0Photo.h"
#endif

using namespace std;

ClassImp(TGenPi0Photo)
...
//_____________________________________________________________________________
  TGenPi0Photo::TGenPi0Photo(Double_t Ebeam, Int_t TargType, UInt_t seed1, UInt_t seed2):TGenBase(Ebeam,seed1,seed2)
{
  // Default constructor
  ...
  cout<<"TGenPi0Photo constructor"<<endl;
...
//_____________________________________________________________________________
TGenPi0Photo::TGenPi0Photo(const TGenPi0Photo& gen):TGenBase(gen)
{
  // Copy constructor
  //  ((TGenPi0Photo&)TCalobase).Copy(*this);
}

//_____________________________________________________________________________
 TGenPi0Photo::~TGenPi0Photo()
{
  // Default destructor
...
//_____________________________________________________________________________
void TGenPi0Photo::IntRCBef(void)
{
...
//_____________________________________________________________________________
void TGenPi0Photo::IntRCAft(void)
{
...
//_____________________________________________________________________________
 void TGenPi0Photo::ComputeElas(void) 
{ 
...
//_____________________________________________________________________________
Double_t TGenPi0Photo::XSec(void)
{
...
Double_t TGenPi0Photo::ArringE(Double_t q2)
{
...
Double_t TGenPi0Photo::ArringM(Double_t q2)
{
...
Double_t TGenPi0Photo::KellyE(Double_t q2)
...
Double_t TGenPi0Photo::KellyM(Double_t q2)
   /* JJ Kelly PRC 70, 068202 (2004)
...
//_____________________________________________________________________________
Double_t TGenPi0Photo::XSecKelly(void)
{
  //Computes the elastic diferential cross-section for the event
...
//_____________________________________________________________________________
Double_t TGenPi0Photo::XSecArrington(void)
{
  //Computes the elastic diferential cross-section for the event
...
//_____________________________________________________________________________
Double_t TGenPi0Photo::XSecTotal(Int_t steps)
{
...
//_____________________________________________________________________________
Double_t TGenPi0Photo::XSecMax(void)
{
...
//_____________________________________________________________________________
void TGenPi0Photo::ApplySpecVerAcc(Double_t aav)
{
...
//_____________________________________________________________________________
 TLorentzVector* TGenPi0Photo::GetFinalProton(void)
{
...
//_____________________________________________________________________________
void TGenPi0Photo::Write2File(void)
{
...
//_____________________________________________________________________________
 void TGenPi0Photo::Print(char* opt)
{
